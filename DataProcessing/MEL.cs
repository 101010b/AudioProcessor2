...
namespace AudioProcessor.DataProcessing
{
    class MEL : RTForm
    {
        ...
        public void InitializeComponent()
        {
            ...
            this.shrinkTitle = "Mel";
            this.Size = new System.Drawing.Size(268, 194);
            this.title = "Mel Coefficients";
        ...
        public MEL(SystemPanel _owner, BinaryReader src) : base(_owner, src)
        {
        ...
        {
            public override List<string> GetAddress() { return new List<string> { "Data", "Mel Coefficents" }; }
            public override RTForm Instantiate() { return new MEL(); }
        }

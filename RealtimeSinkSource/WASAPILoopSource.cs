...
{
    public class WASAPILoopSource : GenericNAudioSinkSource
    {

        public void InitializeComponent()
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(WASAPILoopSource));
            ...
            this.Name = "WASAPILoopSource";
            this.Size = new System.Drawing.Size(320, 84);
            this.title = "WASAPI Loop Device";
        ...
        public void fillDevicesList()
        {
            ...
            MMdevices = deviceEnum.EnumerateAudioEndPoints(DataFlow.All, DeviceState.Active).ToList();
        ...
        public WASAPILoopSource(SystemPanel _owner, BinaryReader src) : base(_owner, src)
        {
        ...
        {
            public override List<string> GetAddress() { return new List<string> { "Source", "Live", "WASAPI Loopback Device" }; }
            public override RTForm Instantiate() { return new WASAPILoopSource(); }
        }
